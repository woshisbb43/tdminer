 ...
 * @author Deb
 */
public class SerialEpisodeCounterWithIntervals extends AbstractSerialCounterInterEventConst
{   static final boolean DEBUG = false; // false to remove debugging
     
    /** Creates a new instance of SerialTrueIntervalCounter */
    public SerialEpisodeCounterWithIntervals()
