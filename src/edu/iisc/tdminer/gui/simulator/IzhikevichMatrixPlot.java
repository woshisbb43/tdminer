/*
 * IzhikevichMatrixPlot.java
 *
 * Created on Nov 3, 2008 9:43 am
 *
 */
 ...
 * @author debprakash
 */
public class IzhikevichMatrixPlot extends Plot
{
    private Color[] carray = null;
    
    private int range = 20;
    private double span = 20.0;
    private ISimulatorPanel container;
    
    /** Creates a new instance of IzhikevichMatrixPlot */
    public IzhikevichMatrixPlot()
    {
        _marks = 2;
        _padding = 0.0;
        _grid = false;
    ...
    public void repaint()
    {
        ...
        if (container != null)
        {
            ...
            _padding = 0.0;
            _grid = false;
            IzhikevichModel sim = (IzhikevichModel)container.getSimulator();
