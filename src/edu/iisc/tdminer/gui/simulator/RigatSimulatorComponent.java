 ...
 * @author  Deb
 */
public class RigatSimulatorComponent extends javax.swing.JPanel implements ITaskPanel, ISimulatorPanel
{
    private RigatSimulator sim = new RigatSimulator();
    ...
    public RigatSimulatorComponent()
    {
        initComponents();
	setDefaultValues();
	...
	sim.setTtotal(jTextFieldTtotal.getText());
        ...
        sim.setStr_eta_base(jTextFieldEtaRest.getText());
        sim.setStr_beta_strong(jTextFieldBetaStrong.getText());
        sim.setStr_beta_self(jTextFieldBetaSelf.getText());
	...
	jTextFieldWeightHigh.setText(sim.getStrHigh());
        ...
        jTextFieldBetaSelf.setText(sim.getStr_beta_self());
        jTextFieldBetaStrong.setText(sim.getStr_beta_strong());
        jTextFieldEtaRest.setText(sim.getStr_eta_base());
    }
    ...
    private void initComponents() {
        ...
        jTextFieldEtaRest = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        jPanel6 = new javax.swing.JPanel();
        jLabel10 = new javax.swing.JLabel();
        jTextFieldBetaStrong = new javax.swing.JTextField();
        jLabel11 = new javax.swing.JLabel();
        jPanel7 = new javax.swing.JPanel();
        jLabel12 = new javax.swing.JLabel();
        jTextFieldBetaSelf = new javax.swing.JTextField();
        jLabel15 = new javax.swing.JLabel();
        jPanelLevel3 = new javax.swing.JPanel();
        jPanel29 = new javax.swing.JPanel();
        simulatorMatrixPlot = new edu.iisc.tdminer.gui.simulator.RigatMatrixPlot();
        ...
        jLabelRandConnStrengthTitle.setText("<html>Random connection strengths (&#x3B2;<sub>rand</sub>):</html>");
        ...
        jPanelLevel2.setLayout(new java.awt.GridLayout(3, 1, 0, 5));

        jPanel3.setLayout(new java.awt.BorderLayout(10, 0));

        jLabel5.setText("<html>Base firing rate co-effficient (&#x3B7;):</html>");
        jLabel5.setToolTipText("(Resting firing rate of neurons)");
        jPanel3.add(jLabel5, java.awt.BorderLayout.WEST);

        jTextFieldEtaRest.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        jTextFieldEtaRest.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                jTextFieldEtaRestInputMethodTextChanged(evt);
            }
        });
        jTextFieldEtaRest.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldEtaRestKeyReleased(evt);
            }
        });
        jPanel3.add(jTextFieldEtaRest, java.awt.BorderLayout.CENTER);
        jPanel3.add(jLabel6, java.awt.BorderLayout.EAST);

        jPanelLevel2.add(jPanel3);

        jPanel6.setLayout(new java.awt.BorderLayout(10, 0));

        jLabel10.setText("<html>Connection strength co-efficient for episodes (&#x3B2;):</html>");
        jLabel10.setToolTipText("(Resting firing rate of neurons)");
        jPanel6.add(jLabel10, java.awt.BorderLayout.WEST);

        jTextFieldBetaStrong.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        jTextFieldBetaStrong.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                jTextFieldBetaStrongInputMethodTextChanged(evt);
            }
        });
        jTextFieldBetaStrong.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBetaStrongKeyReleased(evt);
            }
        });
        jPanel6.add(jTextFieldBetaStrong, java.awt.BorderLayout.CENTER);
        jPanel6.add(jLabel11, java.awt.BorderLayout.EAST);

        jPanelLevel2.add(jPanel6);

        jPanel7.setLayout(new java.awt.BorderLayout(10, 0));

        jLabel12.setText("<html>Neuron self -ve feedback (&#x3B2;<sub>refractory</sub>):</html>");
        jLabel12.setToolTipText("(Resting firing rate of neurons)");
        jPanel7.add(jLabel12, java.awt.BorderLayout.WEST);

        jTextFieldBetaSelf.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        jTextFieldBetaSelf.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                jTextFieldBetaSelfInputMethodTextChanged(evt);
            }
        });
        jTextFieldBetaSelf.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBetaSelfKeyReleased(evt);
            }
        });
        jPanel7.add(jTextFieldBetaSelf, java.awt.BorderLayout.CENTER);
        jPanel7.add(jLabel15, java.awt.BorderLayout.EAST);

        jPanelLevel2.add(jPanel7);
    ...
    private void jTextFieldEtaRestKeyReleased(java.awt.event.KeyEvent evt)//GEN-FIRST:event_jTextFieldEtaRestKeyReleased
    {//GEN-HEADEREND:event_jTextFieldEtaRestKeyReleased
}//GEN-LAST:event_jTextFieldEtaRestKeyReleased
...
// TODO add your handling code here:
    ...
    private void jTextFieldEtaRestInputMethodTextChanged(java.awt.event.InputMethodEvent evt)//GEN-FIRST:event_jTextFieldEtaRestInputMethodTextChanged
    {//GEN-HEADEREND:event_jTextFieldEtaRestInputMethodTextChanged
}//GEN-LAST:event_jTextFieldEtaRestInputMethodTextChanged
...
private void jTextFieldBetaStrongInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_jTextFieldBetaStrongInputMethodTextChanged
// TODO add your handling code here:
}//GEN-LAST:event_jTextFieldBetaStrongInputMethodTextChanged

private void jTextFieldBetaStrongKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBetaStrongKeyReleased
// TODO add your handling code here:
}//GEN-LAST:event_jTextFieldBetaStrongKeyReleased

private void jTextFieldBetaSelfInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_jTextFieldBetaSelfInputMethodTextChanged
// TODO add your handling code here:
}//GEN-LAST:event_jTextFieldBetaSelfInputMethodTextChanged

private void jTextFieldBetaSelfKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBetaSelfKeyReleased
// TODO add your handling code here:
}//GEN-LAST:event_jTextFieldBetaSelfKeyReleased
...
private void jMenuItemSynapseFunctionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSynapseFunctionsActionPerformed
    ...
    public double getBaseConnStrength() {
        try {
            double frest = Double.parseDouble(jTextFieldEtaRest.getText());
    ...
    private javax.swing.JTextField jTextFieldBetaSelf;
    private javax.swing.JTextField jTextFieldBetaStrong;
    private javax.swing.JTextField jTextFieldEtaRest;
    ...
    private edu.iisc.tdminer.gui.simulator.RigatMatrixPlot simulatorMatrixPlot;
	...
	if (selectedRow > -1 && selectedCol > -1 && selectedRow < l.getSize() && selectedCol < l.getSize())
	{
            jLabelStatus.setText("Connection: " + l.getName(selectedRow) + " -> "
                    + l.getName(selectedCol) + " (beta = " + nf.format(w) + ")");
